...
public class Jagdflinte extends weapon {
    public static Map<Player, Integer> playerTimers = new HashMap<>();
    public Jagdflinte(main plugin, ItemStack istack, double damage, long reloadTime, int ammo, long rpmTime) {
    ...
    public void shootEffects(Player player) {
        ...
        player.getLocation().getWorld().playSound(player.getLocation(), Sound.ENTITY_ARROW_SHOOT,(float)0.2,(float) 0.9);
