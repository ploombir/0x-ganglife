...
public class UZI extends weapon {
    ...
    public UZI(main plugin, ItemStack istack, double damage, long reloadTime, int ammo, long rpmTime) {
    ...
    public void shootEffects(Player player) {
        ...
        player.getLocation().getWorld().playSound(player.getLocation(), Sound.ENTITY_SHEEP_HURT, (float)0.2 ,(float) 1.7);
