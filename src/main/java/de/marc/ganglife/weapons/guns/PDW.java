...
public class PDW extends weapon {
    public static Map<Player, Integer> playerTimers = new HashMap<>();
    public PDW(main plugin, ItemStack istack, double damage, long reloadTime, int ammo, long rpmTime) {
    ...
    public void shootEffects(Player player) {
        ...
        player.getLocation().getWorld().playSound(player.getLocation(), Sound.ENTITY_ZOMBIE_AMBIENT,(float)0.2,(float) 0.9);
